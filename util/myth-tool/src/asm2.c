...
Opcode opcodes[] = {
    ...
    { 5, "SYS", "RTS", "Return from subroutine", "C=B PC=O L++" },
    { 6, "SYS", "RTI", "Return from interrupt", "BUSY=0 C=IAB PC=IAO L++" },
    ...
    { 14, "BOP", "IABO", "Copy pointer IA into B:O", "BO=IA PC++" },
    { 15, "BOP", "BOIA", "Copy B:O into pointer IA", "IA=BO PC++" },
    ...
    { 32, "TRAP", "*0", "Trap call to page 0, offset 0 - Set BUSY flag", "BUSY=1 B0=C C=0 IAB=B0 IAO=PC PC=0" },
    { 33, "TRAP", "*1", "Trap call to page 1, offset 0", "B0=C C=1 IAB=B0 IAO=PC PC=0" },
    { 34, "TRAP", "*2", "Trap call to page 2, offset 0", "B0=C C=2 IAB=B0 IAO=PC PC=0" },
    { 35, "TRAP", "*3", "Trap call to page 3, offset 0", "B0=C C=3 IAB=B0 IAO=PC PC=0" },
    { 36, "TRAP", "*4", "Trap call to page 4, offset 0", "B0=C C=4 IAB=B0 IAO=PC PC=0" },
    { 37, "TRAP", "*5", "Trap call to page 5, offset 0", "B0=C C=5 IAB=B0 IAO=PC PC=0" },
    { 38, "TRAP", "*6", "Trap call to page 6, offset 0", "B0=C C=6 IAB=B0 IAO=PC PC=0" },
    { 39, "TRAP", "*7", "Trap call to page 7, offset 0", "B0=C C=7 IAB=B0 IAO=PC PC=0" },
    { 40, "TRAP", "*8", "Trap call to page 8, offset 0", "B0=C C=8 IAB=B0 IAO=PC PC=0" },
    { 41, "TRAP", "*9", "Trap call to page 9, offset 0", "B0=C C=9 IAB=B0 IAO=PC PC=0" },
    { 42, "TRAP", "*10", "Trap call to page 10, offset 0", "B0=C C=10 IAB=B0 IAO=PC PC=0" },
    { 43, "TRAP", "*11", "Trap call to page 11, offset 0", "B0=C C=11 IAB=B0 IAO=PC PC=0" },
    { 44, "TRAP", "*12", "Trap call to page 12, offset 0", "B0=C C=12 IAB=B0 IAO=PC PC=0" },
    { 45, "TRAP", "*13", "Trap call to page 13, offset 0", "B0=C C=13 IAB=B0 IAO=PC PC=0" },
    { 46, "TRAP", "*14", "Trap call to page 14, offset 0", "B0=C C=14 IAB=B0 IAO=PC PC=0" },
    { 47, "TRAP", "*15", "Trap call to page 15, offset 0", "B0=C C=15 IAB=B0 IAO=PC PC=0" },
    { 48, "TRAP", "*16", "Trap call to page 16, offset 0", "B0=C C=16 IAB=B0 IAO=PC PC=0" },
    { 49, "TRAP", "*17", "Trap call to page 17, offset 0", "B0=C C=17 IAB=B0 IAO=PC PC=0" },
    { 50, "TRAP", "*18", "Trap call to page 18, offset 0", "B0=C C=18 IAB=B0 IAO=PC PC=0" },
    { 51, "TRAP", "*19", "Trap call to page 19, offset 0", "B0=C C=19 IAB=B0 IAO=PC PC=0" },
    { 52, "TRAP", "*20", "Trap call to page 20, offset 0", "B0=C C=20 IAB=B0 IAO=PC PC=0" },
    { 53, "TRAP", "*21", "Trap call to page 21, offset 0", "B0=C C=21 IAB=B0 IAO=PC PC=0" },
    { 54, "TRAP", "*22", "Trap call to page 22, offset 0", "B0=C C=22 IAB=B0 IAO=PC PC=0" },
    { 55, "TRAP", "*23", "Trap call to page 23, offset 0", "B0=C C=23 IAB=B0 IAO=PC PC=0" },
    { 56, "TRAP", "*24", "Trap call to page 24, offset 0", "B0=C C=24 IAB=B0 IAO=PC PC=0" },
    { 57, "TRAP", "*25", "Trap call to page 25, offset 0", "B0=C C=25 IAB=B0 IAO=PC PC=0" },
    { 58, "TRAP", "*26", "Trap call to page 26, offset 0", "B0=C C=26 IAB=B0 IAO=PC PC=0" },
    { 59, "TRAP", "*27", "Trap call to page 27, offset 0", "B0=C C=27 IAB=B0 IAO=PC PC=0" },
    { 60, "TRAP", "*28", "Trap call to page 28, offset 0", "B0=C C=28 IAB=B0 IAO=PC PC=0" },
    { 61, "TRAP", "*29", "Trap call to page 29, offset 0", "B0=C C=29 IAB=B0 IAO=PC PC=0" },
    { 62, "TRAP", "*30", "Trap call to page 30, offset 0", "B0=C C=30 IAB=B0 IAO=PC PC=0" },
    { 63, "TRAP", "*31", "Trap call to page 31, offset 0", "B0=C C=31 IAB=B0 IAO=PC PC=0" },
